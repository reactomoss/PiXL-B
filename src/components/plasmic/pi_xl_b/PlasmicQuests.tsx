...
import sty from './PlasmicQuests.module.css'; // plasmic-import: 9QeuLLTh6l8/css
...
export type PlasmicQuests__VariantMembers = {};

export type PlasmicQuests__VariantsArgs = {};
type VariantPropType = keyof PlasmicQuests__VariantsArgs;
export const PlasmicQuests__VariantProps = new Array<VariantPropType>();

export type PlasmicQuests__ArgsType = {};
type ArgPropType = keyof PlasmicQuests__ArgsType;
export const PlasmicQuests__ArgProps = new Array<ArgPropType>();

export type PlasmicQuests__OverridesType = {
  root?: p.Flex<'div'>;
...
export interface DefaultQuestsProps {
  className?: string;
}

function PlasmicQuests__RenderFunc(props: {
  variants: PlasmicQuests__VariantsArgs;
  args: PlasmicQuests__ArgsType;
  overrides: PlasmicQuests__OverridesType;
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              {(
                ...
                <div
                  className={classNames(projectcss.all, sty.freeBox___1CF6B)}
                >
                  {(
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__aWvF5)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
          ...
          {true ? (
            ...
            >
              ...
              >
                ...
                >
                  <div className={classNames(projectcss.all, sty.column__uNEb)}>
                    <div
                    ...
                    >
                      <p.PlasmicImg
                        alt={''}
                        className={classNames(sty.img__gEw5T)}
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__vk9Xi)}
                  >
                    <div
          ...
          {true ? (
            ...
            >
              ...
              >
                <p.PlasmicImg
                  alt={''}
                  className={classNames(sty.img___9KzOx)}
                  displayHeight={
                    hasVariant(globalVariants, 'screen', 'mobileOnly')
                      ? ('auto' as const)
                      : ('auto' as const)
                ...
                <p.PlasmicImg
                  alt={''}
                  className={classNames(sty.img___4HAk5)}
                  displayHeight={
                    hasVariant(globalVariants, 'screen', 'mobileOnly')
                      ? ('auto' as const)
                      : ('85px' as const)
                ...
                <p.PlasmicImg
                  alt={''}
                  className={classNames(sty.img__odKf1)}
                  displayHeight={
                    hasVariant(globalVariants, 'screen', 'mobileOnly')
                      ? ('auto' as const)
                      : ('66px' as const)
                ...
                <p.PlasmicImg
                  alt={''}
                  className={classNames(sty.img__cGoqu)}
                  displayHeight={
                    hasVariant(globalVariants, 'screen', 'mobileOnly')
                      ? ('auto' as const)
                      : ('80.999px' as const)
          ...
          {true ? (
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__vHota)}>
                <div className={classNames(projectcss.all, sty.columns__g7DtY)}>
                  <div
                    className={classNames(projectcss.all, sty.column__kLMiE)}
                  >
                    <p.PlasmicImg
                      alt={''}
                      className={classNames(sty.img__xfuq)}
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column___1DzJt)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
          ...
          >
            ...
            >
              ...
              <p.Stack
                as={'div'}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__if57A)}
              >
                <div className={classNames(projectcss.all, sty.column__kr2U5)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__lZs9)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__ya6Dz)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__go9Y)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__c59Jk)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column___9JkEc)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__aVss4)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__fIkv)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column___0Lx1Z)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__eGpr4)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__zXq1D)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__hdh0M)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column___6NvW5)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__r0FuR)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__tn8Cf)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column___7Ssat)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__reHvu)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__zvyu)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__bx99W)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__viOo)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__rKhci)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__a2QSa)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__svAm)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__gGDxO)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__gdQp1)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                ...
                <div className={classNames(projectcss.all, sty.column__wFb8Z)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.columns___66Xtx)}>
                <div className={classNames(projectcss.all, sty.column__ojA3H)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox___5Eege)}
                  >
                    <h2
                ...
                <div className={classNames(projectcss.all, sty.column__uIvGd)}>
                  <div
          ...
          {true ? (
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__pyDvQ)}>
                <h2
              ...
              <p.Stack
                as={'div'}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns___9Tfvn)}
              >
                <div className={classNames(projectcss.all, sty.column__i8PB3)}>
                  <div
                ...
                <div className={classNames(projectcss.all, sty.column__zI0I5)}>
                  <div
                ...
                <div className={classNames(projectcss.all, sty.column__o4MPj)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                ...
                <div className={classNames(projectcss.all, sty.column__aqO)}>
                  <div
          ...
          {true ? (
            ...
            >
              <div className={classNames(projectcss.all, sty.columns__rCkxh)}>
                <div className={classNames(projectcss.all, sty.column__kOa3)}>
                  <div
                ...
                <div className={classNames(projectcss.all, sty.column__qvJpw)}>
                  <div
                  ...
                  >
                    <p.PlasmicImg
                      alt={''}
                      className={classNames(sty.img__wUfT3)}
                      displayHeight={
                        hasVariant(globalVariants, 'screen', 'mobileOnly')
                          ? ('100%' as const)
                          : ('auto' as const)
          ...
          {true ? (
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__t5X)}>
                <h2
                  className={classNames(
                    projectcss.all,
                    projectcss.h2,
          ...
          >
            <div className={classNames(projectcss.all, sty.columns__du4Yq)}>
              <div className={classNames(projectcss.all, sty.column__x517L)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.column__jJmVz)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
              ...
              <div className={classNames(projectcss.all, sty.column__wyfTg)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
          ...
          <div className={classNames(projectcss.all, sty.freeBox___7Uof)}>
            <div className={classNames(projectcss.all, sty.columns__sEivn)}>
              <div className={classNames(projectcss.all, sty.column__cjgC3)}>
                <p
              ...
              {true ? (
                <div className={classNames(projectcss.all, sty.column___9Zua)}>
                  <p.Stack
                    as={'div'}
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicQuests__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicQuests__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicQuests__ArgProps,
          internalVariantPropNames: PlasmicQuests__VariantProps,
        }),
      [props, nodeName]
    );

    return PlasmicQuests__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === 'root') {
    func.displayName = 'PlasmicQuests';
  } else {
    func.displayName = `PlasmicQuests.${nodeName}`;
  }
  return func;
}

export const PlasmicQuests = Object.assign(
  // Top-level PlasmicQuests renders the root element
  makeNodeComponent('root'),
  {
    ...
    // Metadata about props expected for PlasmicQuests
    internalVariantProps: PlasmicQuests__VariantProps,
    internalArgProps: PlasmicQuests__ArgProps,
  }
);

export default PlasmicQuests;
/* prettier-ignore-end */
