...
import sty from './PlasmicButton.module.css'; // plasmic-import: l1cZrxXjGJlGQf/css
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ge18)}
                role={'img'}
              />
            ),
      ...
      {(hasVariant(variants, 'showEndIcon', 'showEndIcon') ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__eH53R)}
                role={'img'}
              />
            ),
